...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $pseudo = "Tasnime";//$_POST['pseudo'];
    $email = "tahathierry130@gmail.com";// $_POST['email']; // Récupérez l'adresse e-mail depuis le formulaire
    $motDePasse = "Morote60@"; //$_POST['mot_de_passe'];
    $confirmationMotDePasse = "Morote60@"; //$_POST['confirmation_mot_de_passe'];
